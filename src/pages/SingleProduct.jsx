            ...
            <div className="col-lg-5">
              <nav aria-label="breadcrumb">
                <ol className="breadcrumb justify-content-end">
                  ...
                  <li className="breadcrumb-item"><Link to="/products">Articulos</Link></li>
      ...
      <div className="container content">
        <div className="row">
          ...
          <div className="col-lg-7">
            ...
            <br />
            <button className="btn btn-primary btn-sm" onClick={() => navigate(-1)}>REGRESAR</button> &nbsp; 
            <button className="btn btn-primary btn-sm" onClick={() => navigate('/products')}>LISTADO DE ARTICULOS</button> &nbsp;
            <Link to="/products" className="btn btn-primary btn-sm">ARTICULOS</Link>
          </div>
        </div>
      </div>
    </main>
